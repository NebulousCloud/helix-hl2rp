...
Schema.voices.Add("Combine", "404 ZONE", "404 Zone.", "npc/metropolice/vo/404zone.wav"); -- maybe change
...
Schema.voices.Add("Combine", "AIRWATCH 505", "Dispatch, we need airwatch, subject is 505.", "npc/metropolice/vo/airwatchsubjectis505.wav"); -- maybe change
...
Schema.voices.Add("Combine", "POSSIBLE 404", "Possible four-zero-oh here!", "npc/metropolice/vo/possible404here.wav"); -- maybe change
...
Schema.voices.Add("Combine", "SKY SHIELD LOST CONTACT", "Sky shield reports lost contact.", "npc/combine_soldier/vo/skyshieldreportslostcontact.wav"); -- maybe change
...
Schema.voices.Add("Combine", "NECROTICS2", "Necrotics.", "npc/metropolice/vo/necrotics.wav"); -- maybe change thing
...
Schema.voices.Add("Combine", "TEAM ADVANCE", "Team in position, advance.", "npc/metropolice/vo/teaminpositionadvance.wav"); -- maybe change
...
Schema.voices.Add("Combine", "GOING IN", "Cover me, I'm going in!", "npc/metropolice/vo/covermegoingin.wav"); -- maybe change
...
Schema.voices.Add("Combine", "PRIORITY 2", "I have a priority two anti-citizen here!", "npc/metropolice/vo/priority2anticitizenhere.wav"); -- maybe change
...
Schema.voices.Add("Combine", "COVER ME2", "Cover me.", "npc/combine_soldier/vo/coverme.wav"); -- maybe change
...
Schema.voices.Add("Combine", "TERMINAL RESTRICTION", "Terminal restriction zone.", "npc/metropolice/vo/terminalrestrictionzone.wav"); -- maybe change
...
Schema.voices.Add("Combine", "SWEEPING SUSPECT", "Sweeping for suspect.", "npc/metropolice/vo/sweepingforsuspect.wav"); -- maybe change
...
Schema.voices.Add("Combine", "SUBJECT MOVED TO", "Suspect has moved now to.", "npc/metropolice/vo/supsecthasmovednowto.wav"); -- maybe change
...
Schema.voices.Add("Combine", "NINER", "Niner.", "npc/combine_soldier/vo/niner.wav"); -- maybe change thing
...
Schema.voices.Add("Combine", "STABILIZATION TEAM HOLDING", "Stabilization team holding in position.", "npc/combine_soldier/vo/stabilizationteamholding.wav"); -- maybe change
...
Schema.voices.Add("Combine", "PRIORITY OBJECTIVE", "	Priority 1 objective.", "npc/combine_soldier/vo/priority1objective.wav"); -- maybe change
...
Schema.voices.Add("Overwatch", "COPY2", "Copy.", "npc/metropolice/vo/copy.wav"); -- incase someone wants it
...
Schema.voices.Add("Combine", "CHATTER1", "**Indistinct radio chatter**", "npc/combine_soldier/vo/prison_soldier_bunker1.wav"); -- has to be changed
